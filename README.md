...
------
  ...
  Je tiens juste à rappeler que pour pouvoir envoyer des mails avec cette application (j'ai utilisé Gmail pour base de messagerie ici), il faut au préalable activer le paramètre 'Accès moins sécurisé des applications'. Vous le trouverez à l'emplacement suivant depuis votre boite Gmail :  
